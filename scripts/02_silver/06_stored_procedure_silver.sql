...
-- Run the below after DataWarehouse is being used
...
BEGIN
	...
	BEGIN TRY
		...
		/*
		==========================================
		Insert Cleaning Queries Into Tables
		==========================================
		*/
		PRINT '-----------------------------------'
		...
		*/
		...
		PRINT '>> Insterting Table: silver.crm_cust_info'
		...
		*/
		...
		PRINT '>> Insterting Table: silver.crm_prd_info'
		...
		*/
		...
		PRINT '>> Insterting Table: silver.crm_sales_details'
		...
		SELECT 
			...
			CASE 
				...
				ELSE sls_sales -- Else sales is correct
			END AS sls_sales,
			sls_quantity,
			CASE
		...
		*/
		...
		PRINT '>> Insterting Table: silver.erp_cust_az12'
		...
		*/	
		...
		PRINT '>> Insterting Table: silver.erp_loc_a101'
		INSERT INTO silver.erp_loc_a101 (
			cid,
			cntry
		)
		SELECT
			REPLACE(cid, '-', '') cid, -- replace cid to match
			CASE
		...
		*/		
		...
		PRINT '>> Insterting Table: silver.erp_px_cat_g1v2'
